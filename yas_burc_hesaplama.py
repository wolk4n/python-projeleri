# MODÜLLERİ PROGRAMA EKLİYORUZ
import time
import datetime

print('Bugünün tarihi:',time.strftime('%c')) #? Güncel tarihi ekrana yazdırıyoruz.

#! HESAPLAMALAR İÇİN KULLANICIDAN BİLGİLERİNİ İSTİYORUZ...
a=int(input('Doğdugunuz günü giriniz: '))
b=int(input('Doğdugunuz ayı sayı olarak giriniz: '))
c=int(input('Doğdugunuz yılı giriniz: '))

#! VE GİRİLEN BİLGİLERE GÖRE HESAPLAMALARI YAPIYORUZ.
...
#! VE EN SON OLARAK KULLANICININ YAŞINI VE BURCUNU EKRANA YAZDIRIYORUZ. 
